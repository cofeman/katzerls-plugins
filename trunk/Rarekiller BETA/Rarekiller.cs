...
namespace katzerle
{
	class Rarekiller: HBPlugin
	{
        ...
        public Rarekiller()
        {
            ...
            Settings.Load();
            Logging.Write(Colors.MediumPurple, "Rarekiller 3.3a BETA loaded");
...
//KillMobs to List
            ...
            string sPath4 = Path.Combine(FolderPath, "config\\KillTheseMobsToo.xml");
            Logging.WriteDiagnostic(Colors.MediumPurple, "Load KillTheseMobsToo.xml");
            if (File.Exists(sPath4))
            {
                ...
                Logging.WriteDiagnostic(Colors.MediumPurple, "Rarekiller: KillTheseMobsToo.xml loaded");
            }
            else
                Logging.WriteDiagnostic(Colors.MediumPurple, "Rarekiller: File Rarekiller/config/KillTheseMobsToo.xml doesn't exist");
